...
сторінці з телефона. Формат пачки і пастки — `docs/INGEST-CONTRACT.md`;
навіщо це все — `docs/план-wifi-телеметрії.md`.
...
Прошивка має читати тіло відповіді — крок 1b.4 у `docs/план-wifi-реалізація.md`.
