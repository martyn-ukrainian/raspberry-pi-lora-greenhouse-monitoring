...
Метод, числа й джерела: [`docs/нелінійна-шкала.md`](./docs/нелінійна-шкала.md),
...
|---|---:|---|
| `step_a_sleep` — лише `esp_deep_sleep_start()` | 0,84 мА | радіо ніхто не присипляв |
| `step_b_radio` — плюс штатний `radio.sleep()` | 0,70 мА | радіо: **−0,14** |
| `step_e_ropg` — плюс усі піни в `INPUT` | **0,01 мА** | піни: **−0,69** |
| бойова прошивка (контроль) | 0,94 мА | піни ще й від I2C та дисплея |
...
розбір — [`docs/струм-сну.md`](./docs/струм-сну.md).
