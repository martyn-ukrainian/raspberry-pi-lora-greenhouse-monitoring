...
// Розрахунки й перелік проблем — docs/дослідження/power-budget.md.
//
...
// 8 с із запасом.
//
// ЗАМІРЯНО 2026-08-22 (docs/дослідження/калібрування-ґрунту.md): сенсор **v2.0** виходить
...
// docs/дослідження/power-budget.md), тому CRITICAL ставимо трохи вище цієї межі, щоб
...
// 3000, тобто не ефір тут вузьке місце (див. docs/дослідження/power-budget.md).
...
//
// Заміряно 30.08.2026 (`docs/дослідження/струм-сну.md`): без цього вузол у deep sleep їв
